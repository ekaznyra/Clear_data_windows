...
echo                                                                                
echo              ╔═══════════════════════════════════════════════════════╗              
echo              ║   ULTIMATE WINDOWS SYSTEM TOOL v5.0 - COMPLETE       ║              
echo              ║   96 Functions - Full Optimization Suite             ║              
echo              ╚═══════════════════════════════════════════════════════╝              
echo                                                                                
echo  ════════════════════════════════════════════════════════════════════════════════
echo(
...
echo                                                                                
echo              ╔═══════════════════════════════════════════════════════╗              
echo              ║   CÔNG CỤ TỐI ƯU HỆ THỐNG WINDOWS v5.0              ║              
echo              ║   96 Chức năng - Tối ưu Hoàn chỉnh                   ║              
echo              ╚═══════════════════════════════════════════════════════╝              
echo                                                                                
echo  ════════════════════════════════════════════════════════════════════════════════
echo(
